...
ob_start();
session_start();
if(!isset($_SESSION['ac_no']) || !isset($_SESSION['payid']))
...
<table width="100%" height="70%" border="1px">
 <tr>
  <th width="34%" style="margin-left:0px;padding-top:50px">
   ...
   <div style="background:white;height:355px;width:355px;opacity:0.6;text-align:left"><br><br><br>
   <font style="padding-left:0px;padding-left:30px;padding-right:10px">Please note the transaction ID : <?php echo $_SESSION['payid'] ?></font><br><br>
   <font color="green" style="padding-left:0px;padding-left:30px;padding-right:10px">Transaction Status Completed Successfully</font>
   <img style="margin-left:110px;margin-top:50px" src="success.png" height="100" width="130" align="left">
   </div>
   </div>
  </th>
  <th width="66%" style="text-align:left;vertical-align:top">
  <img src="billpay.jpg" height="445" width="867" style="z-index:-1">
  <div style="background:#191970;opacity:0.7;height:120px;width:280px;position:absolute;margin-top:-310px;margin-left:300px;text-align:center;padding-top:40px">
  <font color="white" size="3" face="Candara">Your Payment</font><br>
  <font color="white" size="7" face="Candara">SUCCESS</font>
  </div>
  </th>
 </tr>
</table>

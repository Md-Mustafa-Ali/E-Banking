 ...
 <tr>
  <th width="34%" style="margin-left:0px;padding-top:50px">
   ...
   <form method="post"><br><br>
     <font style="padding-left:0px;padding-left:30px;padding-right:19px">Account No*</font>
     <input type="text" name="ac" placeholder="Account Number" style="outline:none;width:172;height:35;border:0px;background-color:#2b4769;color:white;padding-left:20px"><br><br>
     <font style="padding-left:0px;padding-left:30px;padding-right:43px">Amount*</font>
          ...
          { if(empty($_POST['ac']) || empty($_POST['am']))
              ...
              { if(is_numeric($_POST['ac']) || is_numeric($_POST['am']))
                 { $id=$_SESSION['ac_no'];
                   ...
                   mysqli_query($con,"INSERT INTO tran_".$id."_t (id,type,debit,credit,balance) VALUES('".$id1=gen()."','electricity bill payment','".$_POST['am']."',null,'".$bal."')");
  ...
  <img src="electricity.jpg" height="445" width="874">
  </th>
 </tr>
</table>

...
<?php
  if(isset($_POST['view']))
   {  $_SESSION['month']=$_POST['duration'];
      header("location:tran_view.php");
   }
?>
</table>
<div class="sbi_tab">
...
<table width="100%" height="70%">
 <tr>
  ...
  <th width="73%" style="text-align:left;vertical-align:top">
   ...
   <br>
   <form style="margin-left:50px;margin-top:25" method="post" id="form2">
     <input type="radio" name="duration" value="t" checked>This month
     <input type="radio" name="duration" value="l">Last month
     <button class="button2" type="submit" name="view" style="border-radius:5px;margin-left:24px;background:blue;border:none;height:31px;width:100;color:white">View</button>
   </form>
  </th>
 </tr>
</table>
